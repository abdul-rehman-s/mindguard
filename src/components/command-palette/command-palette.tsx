...
export function CommandPalette() {
  ...
  // Focus trap: keep focus inside the palette when open
  useEffect(() => {
  ...
  // Focus trap: prevent tabbing outside the palette
  useEffect(() => {
    if (!open) return;
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-[10%] sm:top-[15%] z-[101] w-[calc(100%-2rem)] max-w-md -translate-x-1/2"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="overflow-hidden rounded-xl border border-white/[0.08] bg-zinc-900/95 shadow-2xl shadow-black/40 backdrop-blur-xl">
              ...
              {/* Commands */}
              <div className="max-h-48 sm:max-h-72 overflow-y-auto p-2">
                {filtered.length === 0 ? (
                      ...
                      <>
                        ...
                        {actionItems.map((cmd) => {
                          ...
                          return (
                            ...
                            >
                              <Icon className={cn('h-4 w-4 shrink-0', isSelected ? 'text-emerald-400' : 'text-zinc-500')} aria-hidden="true" />
              ...
              {/* Footer hint */}
              <div className="flex items-center gap-4 border-t border-white/[0.04] px-4 py-2.5" aria-hidden="true">
