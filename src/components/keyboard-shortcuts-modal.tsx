  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed left-1/2 top-1/2 z-[61] w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-white/[0.06] bg-zinc-900 shadow-2xl"
      >
        {/* Header */}
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                    {shortcut.keys.map((key, i) => (
                      <span key={i}>
                        {i > 0 && <span className="mx-0.5 text-[10px] text-zinc-700">+</span>}
